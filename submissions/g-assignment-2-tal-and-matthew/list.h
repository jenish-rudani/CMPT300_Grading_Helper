...
// Nodes hold which position in the Node area list they currently hold,
// as well as a pointer to the next and previous Node in the list, on top of the data
typedef struct Node_s Node;
struct Node_s {
    int listNodePosition;
    void* data;
...
// Lists hold what position in the List array that they hold, as well as how many elements long the list is,
// the currently selected list, and the first and last node for easy access
typedef struct List_s List;
struct List_s{
    int listHeadsPosition;
    int listLength;
    bool outOfBounds;
    enum ListOutOfBounds outOfBoundsDirection;
    Node* currentNode;
    Node* firstNode;
    Node* lastNode;
};
...
// Prototypes of helper functions I created
