...
struct Node_s {
    ...
    void* contents;
    struct Node_s* previousElement;
    struct Node_s* nextElement;
    int nodeNumber;
};
...
void printListForwards(List* pList);

//helper debug function to return the index head of the list
int getIndexHead();
...
// pList2 no longer exists after the operation; its listIndexHead is available
// for future operations.
void List_concat(List* pList1, List* pList2);

// Delete pList. pItemFreeFn is a pointer to a routine that frees an item. 
// It should be invoked (within List_free) as: (*pItemFreeFn)(itemToBeFreedFromNode);
// pList and all its nodes no longer exists after the operation; its listIndexHead and nodes are
